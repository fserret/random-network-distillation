...
def main():
    ...
    parser.add_argument('--num-timesteps', type=int, default=1e5)
    ...
    load_test(env_id=args.env, num_env=args.num_env, seed=seed,
        num_timesteps=args.num_timesteps, hps=hps,fname="saved_states/save1")
